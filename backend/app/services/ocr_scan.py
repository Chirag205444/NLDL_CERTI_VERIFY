...
# Initialize PaddleOCR 2.9.1 once when the server starts
ocr = PaddleOCR(
    use_angle_cls=True,
    lang="en"
)
...
def get_ocr_lines(pdf_path):
    ...
    # ]
    #
    # The first list represents the first page.
    ...
    for page_result in result:
        ...
        for item in page_result:
            ...
            # -----------------------------------------
            # Convert 4 corner points into x/y/width/height
            # -----------------------------------------
